...
<div class="flex flex-col space-y-4">
  <div>
    ...
    <p class="text-center">
      Hello and welcome to your personal darts game sponsored and brought to you
      by
      <i>DaSCR</i>
  ...
  <div>
    <h3 class="text-center font-bold text-xl mb-2">Setup your personal game</h3>
    <p class="text-center">
      To start a game you choose a unique game id within the url. So there can
      be more running games concurrently.
    </p>
    <p class="text-center">
    ...
    <p class="text-center">
      <a
        href="{baseURL}/dascr/start"
        class="font-bold">{baseURL}/dascr/start</a>
    </p>
    <p class="text-center">
      You will then be presented with the QR Code to scan with your smartphone
      or tablet to setup your personal game space.
    </p>
  </div>
  <div>
    <h3 class="text-center font-bold text-xl">Player Management</h3>
    <p class="text-center">
      To manage the available players you can use the menu above (top left) or
      navigate your browser to:
    </p>
    <p class="text-center">
      <a href="{baseURL}/player" class="font-bold">{baseURL}/player</a>
    </p>
  </div>
  <!-- hr -->
  <div>
